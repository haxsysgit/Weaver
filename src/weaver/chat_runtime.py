...
WEB_SYSTEM_PROMPT = (
    ...
    "Tool calls are STRUCTURED, never text: do not write '<tool calls>' or a "
    "JSON block as prose - use the tool-call mechanism attached to your "
    "reply, or write the answer.\n"
    "</output>\n"
    "\n"
    "<example>\n"
