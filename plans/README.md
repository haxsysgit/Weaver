...
| [010 - TUI entrypoint](010-tui-entrypoint.md) | Accepted 2026-07-31 | Plan 009 accepted | Owner chat window: weaver chat opens Textual TUI with direct await session.send() |
...
Plan 010 is **Accepted** (2026-07-31); its decision is recorded in
...
`.weaver/config.toml`), both owner-directed. The repo is ready for Plan
011 (direct-reading baseline).
