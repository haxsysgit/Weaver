...
| [003 - Preserve tool protocol and enforce capabilities](003-preserve-tool-protocol.md) | Draft; learning gate pending | Plan 002 accepted | Keep tool calls valid across model steps and refuse inactive tools |
