...
| [005 - Provider-neutral tool payload contract](005-provider-tool-contract.md) | Deterministic floor passed; live permission pending | Plan 004 accepted | Prove the neutral two-request tool round trip through the real SDK path for Flash and Pro |
