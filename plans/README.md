...
| [021 - First Nightmare setup + mobile polish](021-first-nightmare-setup-and-mobile.md) | Admitted 2026-08-17 | v1 (parallel, disjoint frontend files) | First-run animated setup modal (Spell-themed, DeepSeek key explainer + entry), mobile drawer real-app fix, mobile polish + animations |
