...
| [004 - Make cancellation and side effects explicit](004-cancellation-and-side-effects.md) | Implementation and review complete; owner decision pending | Plan 003 accepted | Cancel running async tools cooperatively and block unapproved effect classes |
